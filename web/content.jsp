...
<center>
    <form action="${pageContext.request.contextPath}/queryall" method="post">
        客户姓名:<input type="" name="customername" value="${customername}" />
        客户电话：<input type="" name="phonenumber" value="${phonenumber}"/>
...
<form action="${pageContext.request.contextPath}/delall" method="post" onsubmit="return sureDel()">
    ...
    <table width="80%" height="60%" border="1" cellspacing="0" align="center">
        ...
        <c:forEach items="${pageBean.pageData}" var="customer" varStatus="v">
            <tr>
        ...
        <tr>
            <center>
                ...
                &nbsp;&nbsp;&nbsp;
                <a href="${pageContext.request.contextPath}/findall?currentPage=${pageBean.currentPage-1>1?pageBean.currentPage-1:1}">上一页</a>
                &nbsp;&nbsp;&nbsp;
                <a href="${pageContext.request.contextPath}/findall?currentPage=${pageBean.currentPage+1<pageBean.totalPage?pageBean.currentPage+1:pageBean.totalPage}">下一页</a>
                &nbsp;&nbsp;&nbsp;
                <a href="${pageContext.request.contextPath}/findall?currentPage=${pageBean.totalPage}">末页</a>
            </td>
            </center>
        </tr>
